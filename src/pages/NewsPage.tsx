...
import newsBannerAsset from "@/assets/regions/campina-eixo-urbano.webp";
...
export default function NewsPage() {
  ...
  return <div className="min-h-screen bg-background">
    <PublicPageBanner image={newsBannerAsset} imageAlt="Vista de Campina Grande do Sul, Paraná" locationLabel="Campina Grande do Sul" eyebrow="Portal de notícias" title="Informação que movimenta nossa região" description="Notícias, histórias e novidades das empresas que fazem parte do ecossistema QBCAMP." icon={FileText} />
    <main className="container py-10 md:py-14">
      {approved && <div className="mb-6 flex justify-end"><Button onClick={() => setFormOpen(true)}><Newspaper className="mr-2 h-4 w-4" />Cadastrar notícia</Button></div>}
    ...
    <NewsFormDialog open={formOpen} onOpenChange={setFormOpen} onSaved={loadNews} />
  </div>;
}
