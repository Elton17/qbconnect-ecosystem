...
export default function NewsPage() {
  ...
  return <div className="min-h-screen bg-background">
    <section className="border-b border-border bg-secondary py-14 text-secondary-foreground md:py-20"><div className="container"><div className="max-w-3xl"><div className="mb-4 flex items-center gap-2 text-sm font-semibold text-primary"><FileText className="h-4 w-4" /> PORTAL DE NOTÍCIAS</div><h1 className="text-4xl font-extrabold leading-tight md:text-6xl">Informação que movimenta nossa região</h1><p className="mt-5 max-w-2xl text-lg text-secondary-foreground/70">Notícias, histórias e novidades das empresas que fazem parte do ecossistema QBCAMP.</p></div></div></section>
